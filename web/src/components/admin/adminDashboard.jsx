                ...
                <div className='row justify-content-center'>
                    {
                        orderData.map((v, i) => {
                            return (
                                ...
                                <div className='col-md-5  mr-1 mt-4 py-3 px-3' style={{ boxShadow: "0 0 10px grey", backgroundColor:"yellow" ,color: "black" }}>
                                    <div>
                                        <span>Name:</span>
                                    ...
                                    <div>
                                        <span className='float-right mt-2'>
                                            <button onClick={() => {
                                                updateStatus(v._id)
                                            }} style={{backgroundColor:"green", color:"white",}} >Confirm Order</button>
                                        </span>
                                    </div>
                                </div>
                            )
